...
<body class="min-h-screen bg-gray-100 flex items-top justify-center">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-12">
        <h1 class="text-4xl font-bold mb-12">Create Todo - Documentation</h1>

        <section class="bg-white p-6 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-2">Step 1: Start a new Todo ✍️</h2>
        ...
        <section class="mt-4 bg-white p-6 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-2">Step 2: Add Description 💬</h2>
            <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Sed et ligula eu
                arcu vestibulum viverra sed at felis. Donec lacinia, justo vel tristique ultrices, arcu elit
                fermentum turpis, vel sagittis justo tellus in mauris.</p>
        </section>
        ...
        <section class="mt-4 bg-white p-6 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-2">Step 3: Choose date 📅</h2>
            <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Sed et ligula eu
                arcu vestibulum viverra sed at felis. Donec lacinia, justo vel tristique ultrices, arcu elit
                fermentum turpis, vel sagittis justo tellus in mauris.</p>
        </section>
        ...
        <section class="mt-4">
            <a href="{{ route('todo.create') }}" class="inline-block px-[15px] py-[10px] shadow-md hover:bg-[#5c7cfa80] transition-all duration-500 bg-[#5c7cfa] text-white rounded-md">Let's create!</a>
        </section>
